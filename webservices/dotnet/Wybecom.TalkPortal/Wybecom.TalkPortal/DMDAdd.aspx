<%@ Page Title="<%$Resources:Localization, DMDAddTitle %>" Language="C#" Culture="auto" UICulture="auto" MasterPageFile="~/Talk_Pro.Master" AutoEventWireup="true" CodeBehind="DMDAdd.aspx.cs" Inherits="Wybecom.TalkPortal.DMDAdd" Theme="Wybecom" %>
		...
		<tr valign="top">
			<td width="20%">
				<fieldset>
                    ...
                    <asp:RadioButtonList ID="rblDirectoryType" runat="server" AutoPostBack="true" 
                        onselectedindexchanged="rblDirectoryType_SelectedIndexChanged">
                        <asp:ListItem Text="SQL" Value="SQL" Selected="True" />
					...
					<asp:Panel ID="pnlCiscoSettings" runat="server" Visible="false">
	                    ...
	                    <table width="100%">
						    ...
						    <tr>
							    ...
							    <td>
                                    <asp:TextBox ID="tbAXLUserPassword" runat="server" TextMode="Password"></asp:TextBox>
							    </td>
						    </tr>
						    <tr>
						        <td colspan="2">
							                ...
							                <tr>
							                    ...
							                    <td width="35%" rowspan="3">
                                                    <asp:ListBox ID="lbCiscoFieldFormatters" runat="server" AutoPostBack="true" 
                                                        Width="250" SelectionMode="Single" Rows="7" 
                                                        onselectedindexchanged="lbCiscoFieldFormatters_SelectedIndexChanged">
                                                    <asp:ListItem Text="<%$Resources:Localization, DMDCiscoNameFieldFieldFormatter %>" Value="lastname + ' ,' + firstname#Identity" />
                                                    <asp:ListItem Text="<%$Resources:Localization, DMDCiscoTelephoneFieldFieldFormatter %>" Value="telephonenumber" />  
                                                    </asp:ListBox>
							                    </td>
							                </tr>
							                <tr>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
    <asp:Literal runat="server" Text="<%$Resources:Localization, DMDAddTitle %>" />
</asp:Content>
