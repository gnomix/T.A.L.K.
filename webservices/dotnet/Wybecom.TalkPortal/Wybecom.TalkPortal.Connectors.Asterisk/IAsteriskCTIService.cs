...
{
    // REMARQUE : si vous modifiez le nom d’interface « IAsteriskCTIService » ici, vous devez également mettre à jour la référence à « IAsteriskCTIService » dans App.config.
    [ServiceContract(Namespace = "http://wybecom.org/talkportal/cti/asteriskctiservice")]
    public interface IAsteriskCTIService
    {
        [OperationContract]
        [WebGet()]
