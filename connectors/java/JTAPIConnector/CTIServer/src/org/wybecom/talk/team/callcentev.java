 ...
 */
public class callcentev extends ev implements CallCentEv{

    private int callCenterCause;

    public callcentev(int Cause, int MetaCode, boolean isNew, int eventId, int callCause){
        super(Cause, MetaCode, isNew, eventId);
