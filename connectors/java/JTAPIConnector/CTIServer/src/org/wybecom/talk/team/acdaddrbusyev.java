 ...
 */
public class acdaddrbusyev extends acdaddrev implements ACDAddrBusyEv {

    public acdaddrbusyev(int Cause, int MetaCode, boolean isNew, int eventId, Address sourceAddress, int callCause, Agent ag, AgentTerminal t, Address agAddress, int State){
