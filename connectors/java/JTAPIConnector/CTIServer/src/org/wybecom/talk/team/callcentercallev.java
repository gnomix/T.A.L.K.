 ...
 */
public class callcentercallev extends callev implements CallCentCallEv {
    ...
    public callcentercallev(int Cause, int MetaCode, boolean isNew, int eventId, Call ca, int callCause, Address inAddress, Terminal inTerminal, Address edAddress, Address redirectedAddress){
        super(Cause, MetaCode, isNew, eventId, ca);
        callingAddress = inAddress;
        calledAddress = edAddress;
        callingTerminal = inTerminal;
        lastAddress = redirectedAddress;
