 ...
 */
public class acdaddrnotreadyev extends acdaddrev implements ACDAddrNotReadyEv{

    public acdaddrnotreadyev(int Cause, int MetaCode, boolean isNew, int eventId, Address sourceAddress, int callCause, Agent ag, AgentTerminal t, Address agAddress, int State){
