 ...
 */
public class acdaddrreadyev extends acdaddrev implements ACDAddrReadyEv{

    public acdaddrreadyev(int Cause, int MetaCode, boolean isNew, int eventId, Address sourceAddress, int callCause, Agent ag, AgentTerminal t, Address agAddress, int State){
