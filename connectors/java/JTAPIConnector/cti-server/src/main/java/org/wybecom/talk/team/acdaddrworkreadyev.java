 ...
 */
public class acdaddrworkreadyev extends acdaddrev implements ACDAddrWorkReadyEv{

    public acdaddrworkreadyev(int Cause, int MetaCode, boolean isNew, int eventId, Address sourceAddress, int callCause, Agent ag, AgentTerminal t, Address agAddress, int State){
